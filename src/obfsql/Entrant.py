...
class Entrant:
	"""
	This is the class that stores and retrieves Entrant data.
	"""
	...
	def exportentrants(self):
		...
		query = (
			EntrantObf.select()
			.where(EntrantObf.tournamentID == self.tournamentID)
		...
		for ix in query:
			...
			entrant_subquery = (
				EntrantObf.select(
					EntrantObf.entrantID,
					EntrantObf.entrantTag,
					EntrantObf.finalPlacement,
					EntrantObf.initialSeed,
					EntrantObf.entrantTeam,
					EntrantObf.other,
				)
				.where(
					EntrantObf.entrantTag == ix.entrantTag,
					EntrantObf.tournamentID == ix.tournamentID,
				)
				.get()
			)
